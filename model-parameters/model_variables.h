...
const char* ei_classifier_inferencing_categories[] = { "rattling", "soothing" };
...
ei_dsp_config_mfe_t ei_dsp_config_2 = {
    ...
    40, // int num_filters
    2048, // int fft_length
    30, // int low_frequency
    800, // int high_frequency
    101, // int win_size
...
const ei_impulse_t impulse_631342_0 = {
    .project_id = 631342,
    .project_owner = "Neeraj  Singh",
...
ei_impulse_handle_t impulse_handle_631342_0 = ei_impulse_handle_t( &impulse_631342_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_631342_0;
